...
if($table == "posts")
{
$sql1 = "select * from ".$table." where postid =".$getid;
...
<div class="type-title"> Edit Posts </div>
<table class="data">
<form action="" post="">
<tr><td><input type="text" name="title" class="title" value="<?php echo $row1['title']; ?>"></td></tr>
<tr><td>&nbsp; &nbsp;</td></tr>
<tr><td><textarea name="details" class="details" cols="120" rows="70" ><?php echo htmlspecialchars($row1['details']); ?></textarea></td></tr>
<tr><td>&nbsp; &nbsp;</td></tr>
<tr><td><input type="text" name="author" class="author" value="<?php echo $row1['author'] ?>"></td></tr>
<tr><td>&nbsp; &nbsp;</td></tr>
...
?>
<tr><td><input type="text" name="postdate" class="postdate" value="<?php echo $original1; ?>"></td></tr>
</form>
<?php
}
}
...
{
$sql1 = "select * from ".$table." where featuredid =".$getid;
$rest1 = mysqli_query($conn, $sql1);
while($row1 = mysqli_fetch_assoc($rest1))
{
?>
<div class="post-upload">
<div class="type-title"> Edit Featured Posts </div>
<table class="data">
<form action="" post="">
<tr><td><input type="text" name="title" class="title" value="<?php echo $row1['title']; ?>"></td></tr>
<tr><td>&nbsp; &nbsp;</td></tr>
...
<tr><td>&nbsp; &nbsp;</td></tr>
<?php
$date1 = date_create($row1['uploadedon']);
$original1 = date_format($date1,'d/m/y');
?>
<tr><td><input type="text" name="postdate" class="postdate" value="<?php echo $original1; ?>"></td></tr>
</form>
